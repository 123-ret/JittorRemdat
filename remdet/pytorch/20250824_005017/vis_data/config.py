...
data_root = '/mnt/e/git clone/UAVDT/'
...
test_evaluator = dict(
    ann_file='/mnt/e/git clone/UAVDT/annotations/UAV-benchmark-M-Val.json',
    metric='bbox',
    proposal_nums=(
        100,
        1,
...
train_cfg = dict(
    ...
    val_interval=1)
train_data_prefix = 'images/UAV-benchmark-M'
...
val_data_prefix = 'images/UAV-benchmark-M'
val_dataloader = dict(
    batch_size=2,
    dataset=dict(
        ann_file='annotations/UAV-benchmark-M-Val.json',
